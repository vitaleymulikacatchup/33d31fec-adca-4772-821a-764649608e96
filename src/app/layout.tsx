...
export const metadata: Metadata = {
  title: "Webild - Modern Web Design Platform",
  description: "Create stunning websites with our modern web design platform. Easy-to-use tools, professional templates, and exceptional support.",
  openGraph: {
    title: "Webild - Modern Web Design Platform",
    description: "Create stunning websites with our modern web design platform",
    siteName: "Webild",
    images: [{
      url: "https://images.pexels.com/photos/1779487/pexels-photo-1779487.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Webild Platform Preview"
    }]
  }
};
